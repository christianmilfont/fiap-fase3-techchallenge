...
from telemetry import setup_telemetry #adicionando o otel sdk configurando nos micro serviços
...
setup_telemetry(app, "analytics-service") #adicionando o sdk para coletar os traces
@app.route('/health')
def health():
    tracer = trace.get_tracer("analytics-test")
    with tracer.start_as_current_span("health-check-manual"):
